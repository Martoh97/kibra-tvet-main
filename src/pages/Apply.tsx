...
import { ArrowLeft, ArrowRight, Phone, Mail, MapPin, Check } from "lucide-react";
...
const Apply = () => {
  ...
  const validateStep = (step: number) => {
    switch (step) {
      case 1:
        if (!formData.fullName || !formData.phoneNumber || !formData.gender || !formData.idNumber) {
          toast({
      ...
      case 3:
        ...
        break;
      case 4:
        if (!formData.address || !formData.county || !formData.guardianName || !formData.guardianPhone) {
          toast({
            title: "Required Fields Missing",
            description: "Please fill in all required fields marked with *",
            variant: "destructive",
      ...
      <section className="relative bg-gradient-to-r from-primary via-primary to-primary/90 text-primary-foreground py-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-lg md:text-xl opacity-90 text-center max-w-2xl mx-auto">
            Take the first step towards your future career. Complete your application in just a few minutes.
          </p>
        </div>
      </section>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Select value={formData.department} onValueChange={(value) => handleInputChange("department", value)}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="business">Business & Liberal Studies</SelectItem>
                            <SelectItem value="building">Building and Civil Engineering</SelectItem>
                            <SelectItem value="ict">Computing and Informatics</SelectItem>
                            <SelectItem value="mechanical">Motor Vehicle Technician</SelectItem>
                            <SelectItem value="hospitality">Hospitality and Tourism</SelectItem>
                            <SelectItem value="cosmetology">Cosmetology</SelectItem>
                            <SelectItem value="fashion">Fashion & Garment Making</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <Select value={formData.level} onValueChange={(value) => handleInputChange("level", value)}>
                          ...
                          <SelectContent>
                            <SelectItem value="level6">Level 6 (Diploma)</SelectItem>
                            <SelectItem value="level5">Level 5 (Craft Certificate)</SelectItem>
                            <SelectItem value="level4">Level 4 (Artisan)</SelectItem>
                            <SelectItem value="level3">Level 3 (Vocational Artisan)</SelectItem>
                  ...
                  <div className="flex justify-between pt-6 border-t">
                    ...
                    {currentStep < totalSteps ? (
                      ...
                      <Button onClick={handleSubmit} className="ml-auto bg-accent text-accent-foreground hover:bg-accent/90">
                        Submit Application
                      </Button>
                    )}
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">+254 716 066 759f</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">info@kibratvc.ac.ke</p>
                      <p className="text-sm text-muted-foreground">admissions@kibratvc.ac.ke</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="space-y-2">
                      <Link to="/our-programmes" className="block text-sm text-primary hover:underline">
                        View All Programmes
                      </Link>
                      <Link to="/admissions/entry-requirements" className="block text-sm text-primary hover:underline">
                        Entry Requirements
                      </Link>
                      <Link to="/downloads/fee-structures" className="block text-sm text-primary hover:underline">
                        Fee Structures
                      </Link>
                    </div>
                  </div>
