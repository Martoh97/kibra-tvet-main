              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">P.O. Box 10469-00100, Nairobi, Kenya</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+254722123456" className="text-primary hover:underline">
                      +254 722 123 456
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@kibratvc.ac.ke" className="text-primary hover:underline">
                      info@kibratvc.ac.ke
                    </a>
                  </div>
                </div>
