...
import Prospectus from "./pages/header-downloads/Prospectus";
import CourseCatalogs from "./pages/header-downloads/CourseCatalogs";
import FeeStructures from "./pages/downloads/FeeStructures";
import AcademicCalendar from "./pages/downloads/AcademicCalendar";
import StudentHandbook from "./pages/header-downloads/StudentHandbook";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/departments/business-liberal-studies" element={<BusinessLiberalStudies />} />
            <Route path="/downloads/application-forms" element={<ApplicationForms />} />
            <Route path="/downloads/prospectus" element={<Prospectus />} />
            <Route path="/downloads/course-catalogs" element={<CourseCatalogs />} />
            <Route path="/downloads/fee-structures" element={<FeeStructures />} />
            <Route path="/downloads/academic-calendar" element={<AcademicCalendar />} />
            <Route path="/downloads/student-handbook" element={<StudentHandbook />} />
            <Route path="/management/board-of-governors" element={<BoardOfGovernors />} />
            <Route path="/management/principal" element={<Principal />} />
            <Route path="/management/deputy-principals" element={<DeputyPrincipals />} />
            <Route path="/management/registrar" element={<Registrar />} />
            <Route path="/management/dean-of-students" element={<DeanOfStudents />} />
            <Route path="/admissions/registration" element={<Registration />} />
            <Route path="/admissions/entry-requirements" element={<EntryRequirements />} />
            <Route path="/admissions/payment-details" element={<PaymentDetails />} />
