        ...
        <section className="relative h-[400px] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container mx-auto px-4 text-center text-white">
              <h1 className="text-5xl md:text-6xl font-bold mb-4">Mechanical and Automotive Engineering</h1>
              <p className="text-xl md:text-2xl">Engineering Innovation</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Motor Vehicle Technician - Level 6 & 5</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
                    <span>Motor Vehicle Mechanics - Level 4 & 3</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
                    <span>Welding and Fabrication - Level 4</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-12 p-8 bg-secondary/20 rounded-lg">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Graduates can work as mechanical technicians, automotive mechanics, welding specialists, maintenance engineers, or HVAC technicians in various industrial and manufacturing sectors.
              </p>
            </div>
          </div>
        </section>
