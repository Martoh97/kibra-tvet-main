        ...
        <section className="relative h-[400px] overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container mx-auto px-4 text-center text-white">
              <h1 className="text-5xl md:text-6xl font-bold mb-4">Electrical & Electronics</h1>
              <p className="text-xl md:text-2xl">Powering the Future</p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Electrical Engineering (Power Option) - Level 6 & 5</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
                    <span>Electrical Installation - Level 4 & 3</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">•</span>
                    <span>Solar PV System Installation - Level 5, 4 & 3</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-12 p-8 bg-secondary/20 rounded-lg">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Graduates can work as electricians, electrical technicians, electronics repair specialists, power systems operators, or renewable energy technicians in various industries.
              </p>
            </div>
          </div>
        </section>
